...
// Purpose of file: plugin dns v1.4.0 - GLPI 0.80
// ----------------------------------------------------------------------
 */

$LANG['plugin_canvas']['main'] = 'Gestion graphique des éléments'; // Name of the plugin
$LANG['plugin_canvas']['ancestors'] = 'Items ancêtres';
